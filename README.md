...
Пет-проект для практики по большей части фреймфорка FastAPI.
API для учёта финансов, включающий мультивалютные кошельки, доходы/расходы, переводы между кошельками с конвертацией и журнал операций.
